...
type Master_Loan struct {
	...
	Nasabah_Id          uint64         `gorm:"not null" json:"customer_id,omitempty"`
	Nasabah             Master_Nasabah `gorm:"association_foreignkey:Customer_Id;constraint:onUpdate:CASCADE,onDelete:CASCADE" json:"-"`
